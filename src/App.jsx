...
import SubHero from "./components/SubHero/SubHero"; // Import new component
...
import CustomAssistantsSection from "./components/CustomAssistantsSection/CustomAssistantsSection";
      ...
      <div className="scroll-wrapper">
        <div className="sticky-hero-container" onMouseMove={handleMouseMove}>
          ...
          <main className="main-content">
            ...
            />
            <SubHero scrollProgress={scrollProgress} />
          </main>
